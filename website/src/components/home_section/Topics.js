    ...
    <div className="block w-2/5 mx-auto">
      <div className="flex justify-between items-center px-5 mb-10">
        <Link
          ...
          className="flex justify-end text-2xl text-white font-bold cursor-pointer hover:duration-500 hover:opacity-65"
        >
          ◀️ إستكشف المزيد
        </Link>
        <h1 className="flex justify-end text-4xl text-white font-bold">
          : بعض المدونات
        </h1>
      </div>
